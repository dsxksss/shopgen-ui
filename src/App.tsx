...
function sortHistoryItems(history: WorkspaceHistoryItem[]) {
...
function TopNav({ runtime, activeScenario, hasWorkspace, onClear }: { runtime: RuntimeStatus | null; activeScenario: string; hasWorkspace: boolean; onClear: () => void }) {
